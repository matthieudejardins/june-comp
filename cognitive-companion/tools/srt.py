...
et les transitions. Le LLM (skill companion-session) prononce les phrases produites.
...
class SpacedRetrieval:
    ...
    def respond(self, reply: str, latency_s: float) -> dict:
        """Traite la réponse patient. Renvoie l'action + la phrase de Cognitive Companion."""
        if self.done:
