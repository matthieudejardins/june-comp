...
> skill `madeleine-session` (phase A) DOIT les inclure **mot pour mot**.
...
1. **RAG fermé, zéro invention** : l'agent ne propose **que** des exercices et faits présents
   ...
   est refusée. *(DD §4.1 : « Madeleine ne peut pas laisser un LLM inventer des consignes d'exercices ».)*
