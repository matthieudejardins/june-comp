...
- **NICE NG97** : proscrire l'« entraînement cognitif » décontextualisé (brain-training) —
  inefficace et anxiogène. Madeleine = stimulation **conversationnelle**.
...
- Ne PAS mélanger le graphe `acredity` (autre produit) et le graphe Madeleine → entrée registre dédiée.
